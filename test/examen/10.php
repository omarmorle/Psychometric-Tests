	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form method="post" class="login100-form validate-form" action="11.php">

					<span style="color:white; font-size:20px;">
						9. Si Luis al llegar a su casa observa que le están robando las llantas al automóvil de su
						vecino:
					</span>
					<br><br>
					<span style="color:white; font-size:12px">A) Llamaría a la policía.</span>
					...
					<span style="color:white; font-size:12px;">B) Llamaría a su vecino.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">C) Pediría a los asaltantes parte del beneficio que obtendrán en el robo, por guardar silencio.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">D) Mejor no haría nada y se metería a su casa.
					</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
