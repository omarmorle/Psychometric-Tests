		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form method="post" class="login100-form validate-form" action="12.php">
					...
					<span style="color:white; font-size:12px;">B) Recurrir al sindicato para que éste le ayude.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">C) Que recurra a su guía espiritual para que le diga como se le debe ayudar y su trabajo no se
						le haga pesado.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
