	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form method="post" class="login100-form validate-form" action="10.php">

					<span style="color:white; font-size:20px;">
						8. Un amigo suyo desea obtener un ascenso dentro de su trabajo, usted le aconseja:
					</span>
					<br><br>
					<span style="color:white; font-size:12px">A) Que sea cumplido y eficiente.</span>
					...
					<span style="color:white; font-size:12px;">B) Que busque cuales son los errores del jefe para que demuestre que el no es perfecto.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">C) Que prometa una manda a su santo de preferencia.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">D) Que ofrezca una excelente comida a los dirigentes de la empresa.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
