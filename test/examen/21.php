...
$legal = $_POST['groupOfDefaultRadiosD'];
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form method="post" class="login100-form validate-form" action="suma.php">

					<span style="color:white; font-size:20px;">
						20. Cual de las siguientes ocupaciones escogería:
					</span>
					<br><br>
					<span style="color:white; font-size:12px">A) Trabajar en forma independiente.</span>
					...
					<span style="color:white; font-size:12px;">B) Como encargado del departamento en el cual a usted le gusta.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">C) Dedicarse a estudios de la iglesia.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">D) Trabajador social.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<div class="container-login100-form-btn">
						<a href="2.php"><input type="submit" name="register" value="Terminar"></input></a>
					</div>
