	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form method="post" class="login100-form validate-form" action="16.php">

					<span style="color:white; font-size:20px;">
						14. Si usted viviera en provincia y tuviera más entradas de las que necesita que preferiría
						hacer con el dinero:
					</span>
					<br><br>
					<span style="color:white; font-size:12px">A) Hacerlo producir para ayudar al desarrollo de la industria.</span>
					...
					<span style="color:white; font-size:12px;">B) Donar el dinero para la construcción de una iglesia.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">C) Darlo a una sociedad para el beneficio de las familias humildes del poblado.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">D) Apoyar ayuda al partido político con el cual simpatiza.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
