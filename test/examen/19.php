...
$moral = $_POST['groupOfDefaultRadiosD'];
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form method="post" class="login100-form validate-form" action="20.php">

					<span style="color:white; font-size:20px;">
						18. Su esposa le comenta que al terminar de realizar sus actividades cotidianas le queda
						mucho tiempo libre, usted le sugiere:
					</span>
					<br><br>
					<span style="color:white; font-size:12px">A) Que emplee su tiempo como catequista de la iglesia.</span>
					...
					<span style="color:white; font-size:12px;">B) Que venda artículos femeninos.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">C) Que promueva juntas entre los vecinos encaminadas a resolver los problemas de la comunidad.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">D) Que asista con sus hijos a centros recreativos sí fuera posible.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
