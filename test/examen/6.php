<?php
session_start();
$corrupto = $_POST['groupOfDefaultRadiosB'];
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form method="post" class="login100-form validate-form" action="7.php">

					<span style="color:white; font-size:20px;">
						5. Prefiere una amistad que:
					</span>
					<br><br>
					<span style="color:white; font-size:12px">A) Sea activo y le guste reparar defectos en su hogar.</span>
					...
					<span style="color:white; font-size:12px;">B) Se interese por ser líder en el sindicato del cual forma parte.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">C) Asistir con frecuencia a eventos religiosos.
					</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">D) Le interesa emprender negocios.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
