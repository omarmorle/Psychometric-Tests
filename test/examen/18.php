			...
			<div class="wrap-login100">
				<form method="post" class="login100-form validate-form" action="19.php">
					...
					<span style="color:white; font-size:20px;">
						17. La familia de pero tiene un hijo drogadicto y es amigo de su hijo desde pequeño, al
						saberlo usted:
					</span>
					<br><br>
					...
					<span style="color:white; font-size:12px;">B) Le sugiere a su familia que lo lleven a Centros de Integración Juvenil para que lo ayuden.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					no decírselo a sus padres.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">D) Lo lleva a un centro de rehabilitación junto con su hijo para que sienta que lo apoya y no es
					rechazado.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
