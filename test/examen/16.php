	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form method="post" class="login100-form validate-form" action="17.php">

					<span style="color:white; font-size:20px;">
						15. Su hijo ha dejado sus estudios por un tiempo:
					</span>
					<br><br>
					<span style="color:white; font-size:12px">A) Le sugiere que vea a los maestros para que les proponga que lo ayuden.</span>
					...
					<span style="color:white; font-size:12px;">B) Que haga lo que quiera pues ya está grande.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">C) Que curse nuevamente el año para que pase las materias reprobadas.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">D) Darle apoyo económico y moral para que supere este tropiezo en sus estudios.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
