<?php
session_start();
$corrupto = $_POST['groupOfDefaultRadiosA'];
$legal = $_POST['groupOfDefaultRadiosC'];
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form method="post" class="login100-form validate-form" action="18.php">

					<span style="color:white; font-size:20px;">
						16. A qué actividad prefiere dedicarse durante sus vacaciones:
					</span>
					<br><br>
					<span style="color:white; font-size:12px">A) Obtener experiencia en otro negocio que no sea el propio.</span>
					...
					<span style="color:white; font-size:12px;">B) Participar en la campaña política de diputados que se va a efectuar en su localidad.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">C) Asistir a un retiro organizado por la iglesia.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">D) Visitar un lugar que no conoce, en compañía de su familia.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
