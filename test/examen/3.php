	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form method="post" class="login100-form validate-form" action="4.php">

					<span style="color:white; font-size:20px;">
						2. Cuando ve un accidente usted:
					</span>
					<br><br>
					<span style="color:white; font-size:12px">A) Se pone a orar con la persona accidentada</span>
					...
					<span style="color:white; font-size:12px;">B) Pide una ambulancia.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">C) Cuida las pertenencias del accidentado.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<span style="color:white; font-size:12px;">D) Trata de detener al culpable.</span>
					<div class="custom-control custom-radio" style="color:white; font-size:12px;">
					...
					<div class="container-login100-form-btn">
						<a href="4.php"><input type="submit" name="register" value="Siguiente"></input></a>
					</div>
					<?
						$valor = $_POST['groupOfDefaultRadiosA']; 
							echo $valor;
					?>
